...
import LoadManagedRouteForm from './LoadManagedRouteForm';

// import data to test
import { managedRoutes, currentManagedRoute } from '../../testUtils/testData';
...
const setUp = (props: any) => {
  const component = shallow(<LoadManagedRouteForm {...props} />);
  return component;
};

describe('LoadManagedRouteForm component', () => {
  ...
  it('Schould delete the stop sequence when we click on the delete stop sequence button', () => {
    ...
    expect(onDeleteStopSequence).toBeCalledWith(currentManagedRoute._id);
  });
});
